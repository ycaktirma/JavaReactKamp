...
public class Main {
	...
	public static void main(String[] args) {
		...
		Homework[] dayTwoHomeworksEmirhan = new Homework[]
		{
			dayTwoHomeworkOne
		};
		Homework[] dayTwoHomeworksYarkin = new Homework[]
		{
			dayTwoHomeworkTwo
		};
		...
		yarkin.set_homeworkActive(dayTwoHomeworksYarkin);
		...
		emirhan.set_homeworkActive(dayTwoHomeworksEmirhan);
